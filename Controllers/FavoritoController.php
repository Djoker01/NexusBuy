    ...
    if (is_numeric($id_producto_tienda)) {
        try {
            ...
            if ($resultado) {
                ...
                $historial->crear_historial($descripcion, 1, 2, $id_usuario); // Creación, Módulo Producto
            ...
            echo json_encode(['success' => false, 'error' => 'Error al agregar a favoritos']);
        }
    } else {
    ...
    if (is_numeric($id_producto_tienda)) {
        try {
            ...
            if ($resultado) {
                ...
                $historial->crear_historial($descripcion, 3, 2, $id_usuario); // Eliminación, Módulo Producto
...
if ($_POST['funcion'] == 'obtener_categorias_favoritos') {
    ...
    try {
        ...
        echo json_encode(['success' => false, 'error' => 'Error al cargar categorías']);
    }
}