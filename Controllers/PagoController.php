...
if ($_POST['funcion'] == 'procesar_pago') {
    try {
        ...
        foreach ($items_seleccionados as $item_id) {
            ...
            // Lógica de envío (usar la misma que en el carrito)
            if ($item->envio == 'pago') {
                $envio = 250; // O tu lógica específica
            }
        }
        ...
        $descripcion = "Realizó una compra por $ {$total}. Orden: {$resultado_orden['numero_orden']}";
