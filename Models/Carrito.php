    ...
    function agregar_al_carrito($id_usuario, $id_producto_tienda, $cantidad = 1)
    {
        ...
        try {
            ...
            if ($existente) {
                ...
                return $this->actualizar_cantidad($existente->id, $existente->cantidad + $cantidad);
            } else {
                //Insertar nuevo item
                // Primero verificar stock y obtener precio
                ...
                $sql_insert = "INSERT INTO carrito (id_usuario, id_producto_tienda, cantidad)
                            VALUE (:id_usuario, :id_producto_tienda, :cantidad)";
