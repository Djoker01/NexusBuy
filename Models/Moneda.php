...
class Moneda
{
    ...
    {
        $sql = "SELECT id, codigo, nombre, simbolo, tasa_cambio, activa,
    ...
    function obtener_tasa_cambio($moneda_codigo)
    {
        $sql = "SELECT codigo, nombre, simbolo, tasa_cambio 
                FROM moneda_cambio 
                WHERE codigo = :codigo AND activa = TRUE";
    ...
    {
        try {
            $sql_verificar = "SELECT codigo FROM moneda_cambio WHERE codigo = :codigo AND activa = TRUE";
            ...
            $sql = "INSERT INTO configuracion_usuario (usuario_id, tipo_config, valor_config) 
    ...
    {
        $sql = "SELECT valor_config FROM configuracion_usuario 
