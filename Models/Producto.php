...
class Producto
{
    ...
    $solo_destacados = false, $limite = null)
{
    if ($id) {
        $sql = "SELECT 
                pt.id as id,
        ...
        return $this->llenar_productos_por_categorias($id_categoria, $solo_destacados);
    ...
    function llenar_productos_por_categorias($id_categoria, $solo_destacados = false)
    {
        $sql = "SELECT 
                pt.id as id,
                p.id as id_producto,
    ...
    function buscar_productos($termino, $filtros = array())
    {
        ...
        if (!empty($termino)) {
            $sql .= " AND (p.nombre LIKE :termino OR p.descripcion_larga LIKE :termino OR m.nombre LIKE :termino)";
