      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-6 mb-4">
          ...
          <ul class="list-unstyled">
            <li class="mb-2"><a href="../index.php" class="text-white-50" style="text-decoration: none;">Inicio</a></li>
            <li class="mb-2"><a href="producto.php" class="text-white-50" data-section="Productos" style="text-decoration: none;">Productos</a></li>
            <li class="mb-2"><a href="ofertas.php" class="text-white-50" data-section="Ofertas" style="text-decoration: none;">Ofertas</a></li>
            <li class="mb-2"><a href="producto.php?filtro=nuevos" class="text-white-50" data-section="Nuevos Productos" style="text-decoration: none;">Nuevos</a></li>
            <li class="mb-2"><a href="soporte.php?filtro=contacto" class="text-white-50 footer-link en-desarrollo" data-section="Contacto" style="text-decoration: none;">Contacto</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          ...
          <ul class="list-unstyled">
            <li class="mb-2"><a href="soporte.php?filtro=centro_ayuda" class="text-white-50 footer-link en-desarrollo" data-section="Centro de Ayuda" style="text-decoration: none;">Centro de Ayuda</a></li>
            <li class="mb-2"><a href="soporte.php?filtro=metodos_pago" class="text-white-50 footer-link en-desarrollo" data-section="Métodos de Pago" style="text-decoration: none;">Métodos de Pago</a></li>
            <li class="mb-2"><a href="soporte.php?filtro=envios_entregas" class="text-white-50 footer-link en-desarrollo" data-section="Envíos y Entregas" style="text-decoration: none;">Envíos y Entregas</a></li>
            <li class="mb-2"><a href="soporte.php?filtro=devoluciones" class="text-white-50 footer-link en-desarrollo" data-section="Devoluciones" style="text-decoration: none;">Devoluciones</a></li>
            <li class="mb-2"><a href="soporte.php?filtro=terminos_condiciones" class="text-white-50 footer-link en-desarrollo" data-section="Términos y Condiciones" style="text-decoration: none;">Términos y Condiciones</a></li>
          </ul>
        </div>
