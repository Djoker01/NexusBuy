...
<head>
  ...
  <link rel="shortcut icon" href="Util/Img/png/favicon.ico" type="image/x-icon">
  <title>NexusBuy - Tu Tienda Online de Confianza</title>
</head>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-sm-inline-block">
          <a href="Views/soporte.php" class="nav-link"><i class="fas fa-headset"></i> Soporte</a>
        </li>
      </ul>
    ...
    <a href="Views/notificaciones.php" class="dropdown-item dropdown-footer">Ver todas las Notificaciones</a>
        ...
        <li class="nav-item dropdown" id="nav_usuario">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <div><a class="dropdown-item" href="Views/mi_perfil.php"><i class="fas fa-user-cog"></i> Mi perfil</a></div>
            <div><a class="dropdown-item" href="Views/mis_pedidos.php"><i class="fas fa-shopping-basket"></i> Mis pedidos</a></div>
            <div class="dropdown-divider"></div>
            <div><a class="dropdown-item" href="Controllers/logout.php"><i class="fas fa-sign-out-alt"></i> Cerrar sesión</a></div>
          </div>
        </li>
      </ul>
    </nav>
