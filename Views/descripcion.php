...
<link rel="stylesheet" href="<?php echo $base_path ?>Util/css/cliente/descripcion.css">
              ...
              <div class="product-info">
                ...
                <div class="shipping-card">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h5 class="mb-1" id="shipping-title"></h5>
                      <p class="mb-0" id="shipping-desc"></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="store-card">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      <h5 class="mb-1" style="color:black">Vendido por</h5>
                      <span class="text-muted" id="nombre_tienda"></span>
                    </div>
                    <div class="store-rating">
                      <i class="fas fa-star mr-1"></i>
                      <span id="calificacion_tienda"></span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane fade" id="product-rese" role="tabpanel" aria-labelledby="product-rese-tab">
                ...
                <div id="formulario_reseña" class="mt-4">
                  ...
                  <div class="review-form-container">
                    <h5 class="mb-4" style="color:black">Deja tu reseña</h5>
