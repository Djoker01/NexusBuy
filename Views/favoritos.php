...
<link rel="stylesheet" href="<?php echo $base_path; ?>util/css/cliente/favoritos.css">

<section class="content">
    <div class="container-fluid">
        <!-- Header -->
        <div class="favorites-header">
            <h1 class="favorites-title text-title">
                <i class="fas fa-heart mr-2" style="color: red"></i>Mis Productos Favoritos
            </h1>
        ...
        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <a href="productos.php" class="btn btn-primary btn-block btn-lg">
                                            <i class="fas fa-shopping-bag mr-2"></i>
                                            Explorar Productos
                                        </a>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <a href="mis-pedidos.php" class="btn btn-outline-primary btn-block btn-lg">
            ...
            <div class="col-lg-3">
                ...
                <!-- Recently Viewed -->
                <!-- <div class="card mb-4">
                    <div class="card-header bg-primary text-white footer-link en-desarrollo">
                        <h5 class="mb-0">
