...
?>
<link rel="stylesheet" href="<?php echo $base_path; ?>util/css/cliente/mi-perfil.css">
    ...
    <div class="container-fluid">
        ...
        <div class="profile-header-card">
            ...
            <div class="profile-info">
                ...
                <div class="profile-role" id="tipo_usuario"></div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="config-card">
                                        ...
                                        <div class="config-card-body">
                                            ...
                                            <div id="formulario_tienda">
                                                <div class="alert alert-info">
                                                    <h6 class="text-success"><i class="fas fa-info-circle mr-2"></i>¿Quieres vender en NexusBuy?</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group-modern">
                                                                ...
                                                                <select class="form-control-modern" id="provincia" name="provincia_tienda" required>
                                                                    <option value="">Selecciona una provincia</option>
