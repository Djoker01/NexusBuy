                ...
                <div class="image-upload-grid">
                    ...
                    <div class="image-upload-card">
                        ...
                        <div class="image-preview logo-preview has-image">
                            <img src="<?php echo $base_path; ?>../../Util/Img/tienda/<?php echo $_SESSION['tienda_logo'] ?? 'default_store_logo.png'; ?>" alt="Logo">
                        </div>
                    ...
                    <div class="image-upload-card">
                        ...
                        <div class="image-preview has-image">
                            <img src="<?php echo $base_path; ?>../../Util/Img/banners/<?php echo $_SESSION['tienda_banner'] ?? 'default_store_logo.png'; ?>" alt="Banner">
                        </div>
                        <div class="image-actions">
                            <button class="btn-outline-sm">
                                <i class="fas fa-upload"></i> Cambiar
