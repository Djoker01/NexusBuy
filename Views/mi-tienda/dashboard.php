...
$nombre_usuario = explode(' ', $usuario_actual->nombres)[0];
?>
            
      <?php
// Debug temporal - ELIMINAR EN PRODUCCIÓN
// echo "<!-- DEBUG PHP: ";
// echo "Usuario: " . ($GLOBALS['usuario_actual']->nombres ?? 'NO DISPONIBLE');
// echo " | Tienda: " . ($GLOBALS['tienda_actual']->nombre ?? 'SIN TIENDA');
// echo " | Sesión: " . ($_SESSION['tienda_nombre'] ?? 'NO EN SESIÓN');
// echo " -->";
?>
...
<script>
    $(document).ready(function() {
        $('.page-title p').text('Bienvenido de nuevo, <?php echo $nombre_usuario; ?>. Aquí está el resumen de tu tienda.');
    });
</script>   
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?php echo htmlspecialchars($_SESSION['tienda_calificacion']); ?> ★</div>
