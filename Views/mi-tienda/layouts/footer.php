        ...
        <div class="footer-container">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-social" id="redes">
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        <li><a href="<?php echo $base_path; ?>dashboard.php"><i class="fas fa-chevron-right"></i> Dashboard</a></li>
                        <li><a href="<?php echo $base_path; ?>productos/index.php"><i class="fas fa-chevron-right"></i> Mis Productos</a></li>
                        <li><a href="<?php echo $base_path; ?>pedidos/index.php"><i class="fas fa-chevron-right"></i> Pedidos</a></li>
                        <li><a href="<?php echo $base_path; ?>finanzas/index.php"><i class="fas fa-chevron-right"></i> Finanzas</a></li>
                        <li><a href="<?php echo $base_path; ?>configuracion/index.php"><i class="fas fa-chevron-right"></i> Configuración</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <div class="footer-copyright">
                    &copy; 2024 - <?php echo date('Y'); ?> NexusBuy. Todos los derechos reservados. 
