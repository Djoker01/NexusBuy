...
.category-item-horizontal {
    flex: 0 0 auto;
    width: calc(25% - 19px); /* Equivalente a col-md-3 con gap de 25px */
    min-width: 250px; /* Ancho mínimo para mantener proporción */
}

/* Para pantallas más pequeñas */
@media (max-width: 768px) {
    .category-item-horizontal {
        width: calc(50% - 13px); /* Equivalente a col-6 con gap de 25px */
        min-width: 180px;
    }
}
</style>
            ...
            <div class="card-body">
                <div class="brands-slider">
                    <div class="brand-item">
                        <img src="Util/Img/Marca/samsung.png" alt="Samsung">
                    </div>
                    <div class="brand-item">
                        <img src="Util/Img/Marca/appel.jpeg" alt="Apple">
                    </div>
                    <div class="brand-item">
                        <img src="Util/Img/Marca/Sony.jpeg" alt="Sony">
                    </div>
                    <div class="brand-item">
                        <img src="Util/Img/Marca/LG.png" alt="LG">
                    </div>
                    <div class="brand-item">
                        <img src="Util/Img/Marca/nike.jpeg" alt="Nike">
                    </div>
                    <div class="brand-item">
                        <img src="Util/Img/Marca/adidas.png" alt="Adidas">
                    </div>
                </div>
            </div>
        </div>
